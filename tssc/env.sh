...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/github-tests-go-erruoizi-gitops
...
export TUF_MIRROR="https://tuf-trusted-artifact-signer.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com"
